...
TTFunk::Subset::Base::MICROSOFT_PLATFORM_ID = T.let(T.unsafe(nil), Integer)
TTFunk::Subset::Base::MS_SYMBOL_ENCODING_ID = T.let(T.unsafe(nil), Integer)
...
class TTFunk::Subset::CodePage < ::TTFunk::Subset::Base
  ...
  class << self
    def unicode_mapping_for(encoding); end

    private

    def mapping_cache; end
  end
end
...
TTFunk::Subset::Unicode::SPACE_CHAR = T.let(T.unsafe(nil), Integer)
